...
3. **Atualização da Documentação e Visualização:**
    ...
    *   Leia o PRD (arquivo nível acima ao diretorio da spec) associado a spec e atualize-o para refletir as alterações implementadas. O PRD é um link para um arquivo md no Github, então use o GitHub CLI para ler/atualizar o milestone.
